...
//           <span className="text-gray-300">B.Sc in Visual Arts & Media</span>
//         </p>
//         <p className="flex justify-between border-b border-zinc-800 pb-2">
//           <strong className="text-amber-400">Email:</strong> 
//           <span className="text-gray-300">arnab@retouchlab360.com</span>
//         </p>
//         <p className="flex justify-between border-b border-zinc-800 pb-2">
...
//       {/* Social Media Links */}
//       <div className="pt-2">
//         <h4 className="text-xs font-bold text-amber-400 uppercase tracking-widest mb-3">Social Profiles</h4>
//         <div className="flex flex-wrap gap-3 text-xs sm:text-sm">
//           <a
//             href="https://facebook.com"
//             target="_blank"
//             rel="noopener noreferrer"
//             className="px-4 py-2 rounded-xl bg-zinc-900 border border-amber-500/30 text-gray-300 hover:text-black hover:bg-amber-500 transition-all duration-300 font-semibold"
//           >
//             Facebook
//           </a>
//           <a
